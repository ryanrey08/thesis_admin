	...
	<div class="container">
		...
		<section class="content-header">
			<div class="content">
				<div class="row small">
					<div class="col-sm-12">
						<ol class="breadcrumb float-sm-left bg-light" >
							<li class="breadcrumb-item"><a href="/home">Home</a></li>
							<li class="breadcrumb-item"><a href="/product">Product</a></li>
							<li class="breadcrumb-item active">{{ product.name }}</li>
						</ol>
		...
		<div class="content py-3 py-sm-3 py-md-3 py-lg-3 px-3 px-sm-3 px-md-3 px-lg-3" style="background-color: white;">
			<!-- <div class="row mb-2">
				<div class="col-md-7 p-5">
					<div class="image-viewer w-100 h-100 mb-2" style="background: #ffe6e6;">
						<img :src="imgSrc" class="image-display w-100">
			...
			<div class="row">
				<div class="col-sm-12 col-md-3 col-lg-3">
					<div class="border border-success image-viewer w-100">
